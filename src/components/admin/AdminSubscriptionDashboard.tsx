 ...
 */
export function AdminSubscriptionDashboard({ className }: ComponentProps) {
  // Use ComponentProps directly, destructure className if needed
  ...
  useEffect(() => {
    async function fetchSubscriptions() {
      ...
      try {
        ...
        // Call edge function
        const edgeFunctionUrl = `${VITE_SUPABASE_URL}/functions/v1/admin-get-user-subscriptions`;
        ...
        setError(
          `Failed to load user subscriptions: ${message}. Ensure you have admin privileges.`,
        );
      } finally {
        setIsLoading(false);
      }
