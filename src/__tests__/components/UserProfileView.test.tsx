...
describe.skip("UserProfileView", () => {
  ...
  it("renders correctly when open", async () => {
    ...
    expect(
      screen.getByText("Role changed from student to guardian"),
    ).toBeInTheDocument();
  ...
  it("shows loading state while fetching data", () => {
    ...
    mockGetUserActivity.mockImplementation(
      () =>
        new Promise((resolve) =>
          setTimeout(
            () =>
  ...
  it("filters activities by type", async () => {
    ...
    await waitFor(() => {
      expect(mockGetUserActivity).toHaveBeenCalledWith(
        userId,
    ...
    await waitFor(() => {
      expect(screen.getByText("User logged in")).toBeInTheDocument();
      expect(
        screen.queryByText("Role changed from student to guardian"),
  ...
  it("handles pagination correctly", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Status changed from pending to active"),
      ).toBeInTheDocument();
